...
def lisense():
    ...
    print(type(pin))
        #dob
    address = "25, Sura Appartments, Rajasthan, India"
    print(type(address))
        #dob
    vehicle_type = "03/05/1990"
    print(type(dob))
    
    label_id['text'] = person_id
...
# Create a button
button1 = Button(root, text = "Show Driver's Lisense", command = lisense)
